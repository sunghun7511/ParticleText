...
public final class VectorUtils {
	public static final Vector rotateAroundAxisX(Vector paramVector,
			double paramDouble) {
	...
	public static final Vector rotateAroundAxisY(Vector paramVector,
			double paramDouble) {
		double d3 = Math.cos(paramDouble);
		double d4 = Math.sin(paramDouble);
	...
	public static final Vector rotateAroundAxisZ(Vector paramVector,
			double paramDouble) {
		double d3 = Math.cos(paramDouble);
		double d4 = Math.sin(paramDouble);
	...
	public static final Vector rotateVector(Vector paramVector,
